...
-(void)layoutBtn{
    ...
    for (NSInteger i=0; i<_numOfSubView ;i++) {// 178,245
        CGFloat yy=150+sin((i/_numOfSubView)*M_PI*2+mStartAngle)*(self.frame.size.width/2-_subViewSize.width/2-20);
        CGFloat xx=150+cos((i/_numOfSubView)*M_PI*2+mStartAngle)*(self.frame.size.width/2-_subViewSize.width/2-20);
